        ...
        <>
            <div className="review-sec">
                ...
                <div className="overview">
                    <div className="left">
                        <p className="title">What 160 people are saying</p>
                        ...
                        <button classNameName="add-rev-btn" onClick={() => setIsModalOpen(true)}>Add Review</button>
