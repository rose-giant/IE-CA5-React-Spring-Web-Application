                        ...
                        <div className="title">Available Times for Table #1 (2 seats)</div>
                        {
                            ...
                            <ul>
                                {dates.map((date, index) => (
                                    <li key={index}>
                                        <button classNameName="reserve-btn" style={{ backgroundColor: 'white', color: 'gray', borderColor: 'gray', margin: 0}}>
                                            {date}
                                        </button>
                                    </li>
                                ))}
                            ...
                            <ul>
                                {dates.map((date, index) => (
                                    <li key={index}>
                                        <button classNameName="reserve-btn" style={{ backgroundColor: index === clickedIndex ? '#ED3545' : 'white', 
